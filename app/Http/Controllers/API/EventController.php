...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'event_type' => ['required', 'in:physical,virtual'], 
            'min_age' => ['nullable', 'integer', 'min:0'], 
            'max_age' => ['nullable', 'integer', 'min:0'], 
            'short_description' => ['nullable', 'string'],
            'start_date' => ['required', 'date'],
            'end_date' => ['required', 'date', 'after_or_equal:start_date'],
            'venue_name' => ['required_if:event_type,physical', 'string', 'max:255'], // UPDATE
            'venue_address' => ['required_if:event_type,physical', 'string'], // UPDATE
            'virtual_link' => ['required_if:event_type,virtual', 'url'], // ADD
